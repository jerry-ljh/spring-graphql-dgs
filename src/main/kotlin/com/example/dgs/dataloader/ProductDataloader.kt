...
class ProductDataloader(private val productService: ProductService) : MappedBatchLoader<String, ProductResponse> {

    override fun load(productIdSet: Set<ID>): CompletionStage<Map<String, ProductResponse>> {
